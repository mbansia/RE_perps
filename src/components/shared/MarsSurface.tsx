  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 h-32 pointer-events-none z-0 overflow-hidden">
      ...
      <div
        ...
        style={{
          background: "linear-gradient(180deg, transparent 0%, rgba(12, 4, 4, 0) 20%, rgba(74, 28, 28, 0.08) 60%, rgba(139, 58, 58, 0.12) 100%)",
        }}
      />
      ...
      <div className="absolute bottom-0 left-0 w-[200%] h-16" style={{ animation: "terrainScroll 60s linear infinite" }}>
        <svg viewBox="0 0 2400 64" className="w-full h-full" preserveAspectRatio="none">
          <path
            ...
            fill="rgba(139, 58, 58, 0.2)"
          />
          {/* Craters */}
          <circle cx="350" cy="50" r="6" fill="rgba(45, 17, 17, 0.4)" />
          <circle cx="900" cy="45" r="4" fill="rgba(45, 17, 17, 0.3)" />
          <circle cx="1500" cy="48" r="5" fill="rgba(45, 17, 17, 0.35)" />
          <circle cx="2100" cy="42" r="3" fill="rgba(45, 17, 17, 0.3)" />
        </svg>
      </div>
      ...
      <div className="absolute bottom-0 left-0 w-[200%] h-10" style={{ animation: "terrainScroll 40s linear infinite" }}>
        <svg viewBox="0 0 2400 40" className="w-full h-full" preserveAspectRatio="none">
          <path
            ...
            fill="rgba(199, 91, 59, 0.12)"
          />
        </svg>
      </div>

      {/* Dust particles rising from surface */}
      <div className="absolute bottom-4 left-[20%] w-1 h-1 rounded-full bg-mars-300/20 animate-dust-float" />
      <div className="absolute bottom-6 left-[50%] w-0.5 h-0.5 rounded-full bg-mars-300/15 animate-dust-float" style={{ animationDelay: "3s" }} />
      <div className="absolute bottom-3 left-[75%] w-1 h-1 rounded-full bg-mars-200/10 animate-dust-float" style={{ animationDelay: "7s" }} />
      <div className="absolute bottom-5 left-[35%] w-0.5 h-0.5 rounded-full bg-mars-300/20 animate-dust-float" style={{ animationDelay: "11s" }} />
